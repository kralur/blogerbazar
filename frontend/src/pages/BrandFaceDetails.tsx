...
export function BrandFaceDetails({ id }: { id: string }) {
  ...
  if (failed || !profile) return <div className="screen"><ErrorState onRetry={load} subtitle={t("common.connectionRetry")} title={t("common.openFailed")} /></div>;
  const contacts = [
  ...
  return <div className="screen pb-28 pt-5">
    <a aria-label={t("common.back")} className="grid h-11 w-11 place-items-center rounded-2xl bg-white shadow-card" href="#/"><Icon name="back" /></a>
