...
export function Favorites() {
  ...
  return <div className="screen screen--with-nav">
    <header className="flex items-center gap-3"><a aria-label={t("favorites.backAria")} className="grid h-11 w-11 place-items-center rounded-2xl bg-white shadow-card" href="#/profile"><Icon name="back" /></a><div><p className="text-sm font-semibold text-brand-muted">{t("profile.eyebrow")}</p><h1 className="mt-1 text-3xl font-extrabold tracking-tight">{t("favorites.title")}</h1></div></header>
    <div className="mt-5">
