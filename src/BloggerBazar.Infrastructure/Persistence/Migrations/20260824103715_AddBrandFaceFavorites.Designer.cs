...
namespace BloggerBazar.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260824103715_AddBrandFaceFavorites")]
    partial class AddBrandFaceFavorites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BloggerBazar.Domain.Entities.BrandFaceFavorite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("BrandFaceId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BrandFaceId");

                    b.HasIndex("PlatformUserId", "BrandFaceId")
                        .IsUnique();

                    b.HasIndex("PlatformUserId", "CreatedAtUtc", "Id");

                    b.ToTable("brand_face_favorites", (string)null);
                });
            ...
            modelBuilder.Entity("BloggerBazar.Domain.Entities.BrandFaceFavorite", b =>
                {
                    b.HasOne("BloggerBazar.Domain.Entities.BrandFaceProfile", null)
                        .WithMany()
                        .HasForeignKey("BrandFaceId")
